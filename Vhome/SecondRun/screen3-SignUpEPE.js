  ...
  return (
    <View
      ...
      <View
        ...
        />
        <TextInput style={{flex: 1, fontSize: 18}} placeholder="Họ và tên" />
      </View>
      <View
        style={{
          flexDirection: 'row',
        ...
        <View>
          ...
          <View
            ...
            <TouchableOpacity
              ...
              <Image
                source={Tick ? {uri: adr.sc3E.f7} : {uri: adr.sc3E.f8}}
                style={{
                  resizeMode: 'contain',
                  height: '28%',
                }}
      ...
      <View
        ...
        <Text style={{fontSize: 15, marginLeft: -120, color: 'grey'}}>
          Bạn đã có tài khoản?
        </Text>

        <TouchableOpacity onPress={() => navigation.navigate('SignIn2')}>
          <Text
            style={{marginLeft: 120, top: -18, color: 'orange', fontSize: 15}}>
            Về đăng nhập
          </Text>
        </TouchableOpacity>
      </View>
