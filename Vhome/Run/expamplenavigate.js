    ...
    return (
        <View style={{
                ...
                <TextInput style={{
                    ...
                    onChangeText={
                        (value) => {typedText(value)
                            setDestiantion(value === 'nhan vien' ? "Đăng ký" : "Đăng kí 2")
                        }} 
                        value={text}
                />
            </View>
            <Text style={{ marginLeft: 20,color:'black' }}>{destination}</Text>
            <View style={{
                position: 'relative',
                alignSelf: 'stretch',
                justifyContent: 'center'
            ...
            <View style={{
                ...
                <TouchableOpacity onPress={()=>navigation.navigate(destination)}><Image source={require('/Users/anhlumi/VHome/Vhome/VHomeImg/logo/log_in.png')}
                    style={{
...
<View style={{position:'relative',alignItems:'center'}}>
    <View style={{ left:85 }}><TouchableOpacity onPress={() => navigation.navigate("Đăng ký")} >
            ...
            <TouchableOpacity onPress={() => navigation.navigate("Lấy lại mật khẩu")}><Text style={{top:20,  color: 'orange', fontSize: 16,textDecorationLine:'underline' }}>Quên mật khẩu</Text></TouchableOpacity>
