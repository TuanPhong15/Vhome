...
//     VisibleDate(false), setChosenDate(moment(date).format('Do MMMM YYYY '));
//   };
...
//                   <Image
//                     style={{width: (32 * 80) / 100, height: (32 * 80) / 100}}
...
//             <View
//               style={{width: screenWidth / 1.1, alignItems: 'center', top: 10}}>
//               <Image
...
//                   <Text style={{top: 35, left: -25, fontSize: 20}}>
//                     {service}
//                   </Text>
//                 </TouchableOpacity>
//                 <Image
...
//             <View style={{flexDirection: 'row'}}>
//               <Text
//                 style={{fontSize: 20, marginTop: 25, textAlign: 'left'}}
//                 onPress={() => {
//                   setService('DV Cung cấp nước sạch'), hideModal2(!modal2);
//                 }}>
...
//                 onPress={() => {
//                   setService('Sửa chữa tại nhà'), hideModal2(!modal2);
//                 }}>
//                 Sửa chữa tại nhà
//               </Text>
...
//                 style={{fontSize: 20, marginTop: 25}}
//                 onPress={() => {
//                   setService('DV Bảo vệ môi trường'), hideModal2(!modal2);
//                 }}>
...
//                 style={{fontSize: 20, marginTop: 25}}
//                 onPress={() => {
//                   setService('Chăm sóc sức khoẻ'), hideModal2(!modal2);
//                 }}>
//                 Chăm sóc sức khoẻ
//               </Text>
